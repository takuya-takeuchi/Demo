...
if(NOT TARGET ZLIB::ZLIB)
    if (MSVC)
        ...
        set_property(TARGET ZLIB::ZLIB PROPERTY IMPORTED_LOCATION ${zlib_BINARY_DIR}/${CMAKE_BUILD_TYPE}/zlib.lib)
        ...
        set(ZLIB_LIBRARY ${zlib_BINARY_DIR}/${CMAKE_BUILD_TYPE}/zlib.lib CACHE INTERNAL "")
    elseif (APPLE)
        add_library(ZLIB::ZLIB STATIC IMPORTED GLOBAL)
