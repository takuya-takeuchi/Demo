...
bool IsObviouslyLinearTraversal(int rows, int cols, int depth,
  ...
  // https://qiita.com/fulcrum/items/4864c7d6a66eb0c51fba
  // external/ruy/ruy/block_map.cc(334): error C2676:
  return GetTraversalOrder(rows, cols, depth, lhs_scalar_size, rhs_scalar_size, cpu_cache_params) == BlockMapTraversalOrder::kLinear;
}
