...
{
   $arguments = @()
   $arguments += New-Object PSObject -Property @{ Version = "v2.5.3";  }
   $arguments += New-Object PSObject -Property @{ Version = "v2.10.1"; }
   $arguments += New-Object PSObject -Property @{ Version = "v2.11.1"; }
   $arguments += New-Object PSObject -Property @{ Version = "v2.12.1"; }
