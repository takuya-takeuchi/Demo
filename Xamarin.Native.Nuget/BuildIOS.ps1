...
# device
Write-Host "Build iOS Native Device Library" -Foreground Green
$buildDir = Join-Path Native build_ios_device
...
# simulator
Write-Host "Build iOS Native Simulator Library" -Foreground Green
$buildDir = Join-Path Native build_ios_simulator
$installDir = Join-Path $curret Native | `
