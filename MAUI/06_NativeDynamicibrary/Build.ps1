...
function BuildIOS()
{
      ...
      Write-Host "Create xcframework" -Foreground Green
      xcodebuild -create-xcframework `
                 -framework install/NativeAdd/ios_device/lib/NativeAdd.framework `
                 -framework install/NativeAdd/ios_simulator/lib/NativeAdd.framework `
