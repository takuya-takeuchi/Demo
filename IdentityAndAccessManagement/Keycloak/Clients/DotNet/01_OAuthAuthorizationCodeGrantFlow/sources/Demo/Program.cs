...
namespace Demo
{
    ...
    internal sealed class Program
    {
        ...
        private static async Task Main(string[] args)
        {
            ...
            var p = new Program();
            await p.DoOAuthAsync("console", "olAOSRZh04pYnLoyLre3vzsEzSLjNUOx");
        }
        ...
        private async Task DoOAuthAsync(string clientId, string clientSecret)
        {
            ...
            await ExchangeCodeForTokensAsync(code, redirectUri, clientId, clientSecret);
        }

        private static async Task ExchangeCodeForTokensAsync(string code, string redirectUri, string clientId, string clientSecret)
        {
            ...
            requestParameter.Add($"client_id={clientId}");
            requestParameter.Add($"client_secret={clientSecret}");
